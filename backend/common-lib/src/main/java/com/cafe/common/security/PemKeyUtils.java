...
/**
 * Parses PKCS8 private / X.509 public PEM text - configured locally in each service's own
 * application.yml - into java.security key objects for RS256 JWT signing/verification.
 */
