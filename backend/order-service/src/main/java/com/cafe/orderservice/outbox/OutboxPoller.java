 ...
 * per-item try/catch shape as inventory-service's InboxPoller (the receive-side mirror of this
 * class). Not itself @Transactional: claimBatch() and publishOne()/recordFailure() are separate
