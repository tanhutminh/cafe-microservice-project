...
public class MenuItemController {
    ...
    public List<MenuItemResponse> search(
            @Parameter(description = "Only return items in this category", example = "1") @RequestParam(required = false) @Positive Long categoryId,
    ...
    public MenuItemResponse findById(@Parameter(description = "The menu item's id", example = "12") @PathVariable @Positive Long id) {
    ...
    public MenuItemResponse update(@Parameter(description = "The menu item's id", example = "12") @PathVariable @Positive Long id, @Valid @RequestBody MenuItemRequest request) {
    ...
    public MenuItemResponse updateAvailability(@Parameter(description = "The menu item's id", example = "12") @PathVariable @Positive Long id, @Valid @RequestBody UpdateAvailabilityRequest request) {
