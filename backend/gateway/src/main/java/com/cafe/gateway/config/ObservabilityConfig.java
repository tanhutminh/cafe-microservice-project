...
public class ObservabilityConfig {
   ...
   * "http.server.requests" and filtering by name would suppress tracing for every endpoint. Uses
   * the reactive context type since this service runs on WebFlux, not Servlet. Assumes the default
   * actuator base path ("/actuator"); changing management.endpoints.web.base-path would silently
