...
@Tag(name = "Recipes", description = "Which ingredients (and how much) each menu item consumes on checkout")
public class RecipeController {
    ...
    @Operation(
            ...
            description = "This is a full replace, not a per-line patch: send every line the recipe "
